...
(custom-set-variables
 ...
 '(package-selected-packages
   '(spacious-padding typo magit git dired-git sublime-themes sublimity smart-mode-line minesweeper telega fb2-reader easy-jekyll all-the-icons google-translate dashboard page-break-lines pdf-tools fountain-mode treemacs centaur-tabs ef-themes lsp-treemacs writeroom-mode olivetti ## org-modern))
 '(sml/extra-filler 0)
...
(custom-set-faces
 ...
 '(fringe ((t :background "#f8f5ff")))
 '(header-line ((t :box (:line-width 4 :color "#ebe7f1" :style nil))))
 '(header-line-highlight ((t :box (:color "#4f3363"))))
 '(keycast-key ((t)))
 '(line-number ((t :background "#f8f5ff")))
 '(mode-line ((t :box (:line-width 6 :color "#ddb4ff" :style nil))))
 '(mode-line-active ((t :box (:line-width 6 :color "#ddb4ff" :style nil))))
 '(mode-line-highlight ((t :box (:color "#4f3363"))))
 '(mode-line-inactive ((t :box (:line-width 6 :color "#e3e0e9" :style nil))))
 '(tab-bar-tab ((t :box (:line-width 4 :color "#f8f5ff" :style nil))))
 '(tab-bar-tab-inactive ((t :box (:line-width 4 :color "#c3c0c9" :style nil))))
 '(tab-line-tab ((t)))
 '(tab-line-tab-active ((t)))
 '(tab-line-tab-inactive ((t)))
 '(treemacs-root-face ((t (:foreground "black"))))
 '(vertical-border ((t :background "#f8f5ff" :foreground "#f8f5ff")))
 '(window-divider ((t (:background "#f8f5ff" :foreground "#f8f5ff"))))
 '(window-divider-first-pixel ((t (:background "#f8f5ff" :foreground "#f8f5ff"))))
 '(window-divider-last-pixel ((t (:background "#f8f5ff" :foreground "#f8f5ff")))))
...
(defun my/org-archive-done-tasks ()
  "Archive the current entry if it is marked DONE."
